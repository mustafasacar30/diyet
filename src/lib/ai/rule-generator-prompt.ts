...
- **ÖĞÜN İSİMLERİNDE HALÜSİNASYON VE BİLGİLENDİRME:** Kullanıcı "her öğünde" veya "tüm gün" diyorsa ve hastanın (size iletilen MEAL SETTINGS içinde) Kahvaltı veya Ara Öğün gibi standart öğünlerinden biri EKSİKSE;
    1. Kafanızdan "kahvaltı, öğlen, akşam, ara öğüne ekledim" diye UYDURMA YAPMAYIN!
    2. Bunun yerine "explanation" kısmında hastayı dürüstçe BİLGİLENDİRİN: "Sizin menünüzde sadece Öğlen ve Akşam öğünleri bulunuyor, tahini bu öğünlerinize ekledim."
